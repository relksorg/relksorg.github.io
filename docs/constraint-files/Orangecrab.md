...
* Gpio pins are now referenced by: gpio[6:0]
...
LOCATE COMP "gpio[0]" SITE "B10";
IOBUF PORT "gpio[0]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[0]" PULLMODE=DOWN;
LOCATE COMP "gpio[1]" SITE "B9";
IOBUF PORT "gpio[1]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[1]" PULLMODE=DOWN;
LOCATE COMP "gpio[2]" SITE "C8";
IOBUF PORT "gpio[2]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[2]" PULLMODE=DOWN;
LOCATE COMP "gpio[3]" SITE "B8";
IOBUF PORT "gpio[3]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[3]" PULLMODE=DOWN;
LOCATE COMP "gpio[4]" SITE "A8";
IOBUF PORT "gpio[4]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[4]" PULLMODE=DOWN;
LOCATE COMP "gpio[5]" SITE "H2";
IOBUF PORT "gpio[5]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[5]" PULLMODE=DOWN;
LOCATE COMP "gpio[6]" SITE "J2";
IOBUF PORT "gpio[6]" IO_TYPE=LVCMOS33;
IOBUF PORT "gpio[6]" PULLMODE=DOWN;
