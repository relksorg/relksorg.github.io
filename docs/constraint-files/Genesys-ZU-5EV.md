...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sysclk_IBUF_inst/O]
...
## PMOD JB
#set_property -dict { PACKAGE_PIN AE13  IOSTANDARD LVCMOS33 } [get_ports { ledCheck }]; #IO_L8N_HDGC_AD4N_46/26 Sch=jb[1]
...
## PMOD JC
set_property -dict { PACKAGE_PIN E13  IOSTANDARD LVCMOS33 } [get_ports { clkOutPrimary }]; #IO_L6N_HDGC_AD6N_46/26 Sch=jc[1]
set_property -dict { PACKAGE_PIN G13  IOSTANDARD LVCMOS33 } [get_ports { clkOutSecondary }]; #IO_L7P_HDGC_AD5P_46/26 Sch=jc[2]
...
## PMOD JD
set_property -dict {PACKAGE_PIN E15  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[0] }]; #IO_L4P_AD12P_44/24 Sch=jd[1]
set_property -dict {PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[1] }]; #IO_L2P_AD14P_44/24 Sch=jd[2]
set_property -dict {PACKAGE_PIN B15  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[2] }]; #IO_L2N_AD14N_44/24 Sch=jd[3]
set_property -dict {PACKAGE_PIN F15  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[3] }]; #IO_L3P_AD13P_44/24 Sch=jd[4]
set_property -dict {PACKAGE_PIN E14  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[4] }]; #IO_L1N_AD15N_44/24 Sch=jd[7]
set_property -dict {PACKAGE_PIN B14  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[5] }]; #IO_L4N_AD12N_44/24 Sch=jd[8]
set_property -dict {PACKAGE_PIN D15  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[6] }]; #IO_L1P_AD15P_44/24 Sch=jd[9]
set_property -dict {PACKAGE_PIN A15  IOSTANDARD LVCMOS33 } [get_ports { ledCheck[7] }]; #IO_L3N_AD13N_44/24 Sch=jd[10]
...
## Switches
set_property -dict { PACKAGE_PIN AB14  IOSTANDARD LVCMOS33 } [get_ports { sw[3] }]; #IO_L8N_HDGC_44/24 Sch=sw[0]
set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS33 } [get_ports { sw[2] }]; #IO_L10N_AD10N_44/24 Sch=sw[1]
set_property -dict { PACKAGE_PIN W12   IOSTANDARD LVCMOS33 } [get_ports { sw[1] }]; #IO_L11P_AD9P_44/24 Sch=sw[2]
set_property -dict { PACKAGE_PIN AB15  IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; #IO_L8P_HDGC_44/24 Sch=sw[3]
